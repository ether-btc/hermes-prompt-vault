  ...
  (function() {
    ...
    function Toast({ message, type = "success", onClose }) {
      ...
      return React.createElement(
        "div",
        { className: `pv-toast ${bg}` },
        React.createElement("span", null, message),
        React.createElement(
          "button",
          { onClick: onClose, className: "pv-toast-close" },
    ...
    function Combobox({ value, onChange, options, placeholder }) {
      ...
      return React.createElement(
        "div",
        { ref: wrapRef, className: "pv-combobox" },
        ...
        open && filtered.length > 0 && React.createElement(
          "div",
          { className: "pv-combobox-list" },
          filtered.map(
            (opt, i) => React.createElement("div", {
              key: opt,
    ...
    function Modal({ title, children, onClose, wide }) {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: "pv-modal-header" },
            React.createElement("h2", { className: "pv-modal-title" }, title),
            React.createElement(
              "button",
              { onClick: onClose, className: "pv-icon-btn" },
    ...
    function PromptForm({ prompt, allTags, allCategories, onSave, onCancel }) {
      ...
      return React.createElement(
        "form",
        { onSubmit: handleSubmit, className: "pv-form" },
        React.createElement(
          "div",
          { className: "pv-field" },
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: "pv-field pv-field-grow" },
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: "pv-tags-input" },
            tags.map(
              (t) => React.createElement(
                "span",
                { key: t, className: "pv-tag pv-tag-removable", onClick: () => removeTag(t) },
                t,
    ...
    function VersionHistory({ promptId, onRestore }) {
      ...
      return React.createElement(
        "div",
        { className: "pv-versions" },
        versions.map(
          (v) => React.createElement(
            "div",
            { key: v.id, className: "pv-version-card" },
            React.createElement(
              "div",
              { className: "pv-version-meta" },
              React.createElement(
                "span",
                { className: "pv-version-date" },
    ...
    function PromptCard({ prompt, onEdit, onDelete, onCopy, onToggleFav, onView }) {
      ...
      return React.createElement(
        "div",
        { className: "pv-prompt-card", onClick: () => onView(prompt) },
        React.createElement(
          "div",
          { className: "pv-card-top" },
          React.createElement(
            "div",
            { className: "pv-card-title-row" },
            ...
            React.createElement(
              ...
              prompt.favorite ? React.createElement(Icons.starFill, { size: 16 }) : React.createElement(Icons.star, { size: 16 })
            )
          ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              copied ? React.createElement(Icons.check, { size: 14, className: "pv-color-green" }) : React.createElement(Icons.copy, { size: 14 })
            ),
            React.createElement("button", {
              className: "pv-icon-btn pv-icon-btn-sm",
              onClick: (e) => {
        ...
        prompt.run_count > 0 && React.createElement(
          "div",
          { className: "pv-card-runs" },
          React.createElement(Icons.zap, { size: 12 }),
          ` Used ${prompt.run_count} time${prompt.run_count !== 1 ? "s" : ""}`
        )
      );
    }
    function PromptDetail({ prompt, onBack, onEdit }) {
      ...
      return React.createElement(
        ...
        React.createElement(
          "div",
          { className: "pv-detail-nav" },
          React.createElement(
            "button",
            { className: "pv-btn pv-btn-ghost pv-btn-sm", onClick: onBack },
            "Back to list"
          ),
          React.createElement(
            "div",
            { className: "pv-detail-actions" },
            React.createElement(
              "button",
              {
            ...
            React.createElement(
              ...
              copied ? [React.createElement(Icons.check, { size: 14, key: "c" }), " Copied!"] : [React.createElement(Icons.copy, { size: 14, key: "c" }), " Copy & Use"]
            )
          )
        ),
        React.createElement(
          "div",
          { className: "pv-detail-header" },
          ...
          React.createElement(
            "div",
            { className: "pv-detail-meta" },
            prompt.category && React.createElement("span", { className: "pv-tag pv-tag-category" }, prompt.category),
            prompt.tags.map((t) => React.createElement("span", { key: t, className: "pv-tag" }, t)),
            React.createElement(
              "span",
              { className: "pv-detail-date" },
              "Created ",
              timeAgo(prompt.created_at)
            ),
            prompt.updated_at !== prompt.created_at && React.createElement(
              "span",
              { className: "pv-detail-date" },
              "Updated ",
            ...
            prompt.run_count > 0 && React.createElement(
              "span",
              { className: "pv-detail-runs" },
              React.createElement(Icons.zap, { size: 13 }),
              ` Used ${prompt.run_count}x`
            )
          )
        ),
    ...
    function ImportExport({ onImport, onClose }) {
      ...
      return React.createElement(
        "div",
        { className: "pv-import-export" },
        React.createElement(
          "div",
          { className: "pv-ie-tabs" },
          React.createElement("button", {
        ...
        tab === "export" && React.createElement(
          "div",
          null,
          loading ? React.createElement("div", { className: "pv-loading" }, "Loading...") : React.createElement(
            "div",
            null,
            React.createElement(
              "p",
        ...
        tab === "import" && React.createElement(
          "div",
          null,
      ...
      return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "span",
                null,
                React.createElement(Icons.book, { size: 13 }),
                ` ${stats.total_prompts || 0} prompts`
              ),
              React.createElement(
                "span",
                null,
                React.createElement(Icons.starFill, { size: 13 }),
                ` ${stats.total_favorites || 0} favs`
              ),
              React.createElement(
                "span",
                null,
                React.createElement(Icons.zap, { size: 13 }),
                ` ${stats.total_runs || 0} runs`
              )
            )
          ),
          React.createElement(
            "div",
            { className: "pv-header-right" },
            React.createElement("button", {
              className: "pv-btn pv-btn-ghost pv-btn-sm",
        ...
        view === "list" && React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "pv-filters" },
              allCategories.length > 0 && React.createElement(
                "select",
                {
                  className: "pv-select",
          ...
          // Results count
          (search || filterTag || filterCategory || showFavOnly) && React.createElement(
            "div",
            { className: "pv-results-count" },
            `${filteredCount} of ${total} prompts`
          ),
          // Prompt grid
          loading ? React.createElement("div", { className: "pv-loading" }, "Loading prompts...") : prompts.length === 0 ? React.createElement(
            "div",
            { className: "pv-empty" },
            ...
            { className: "pv-grid" },
            prompts.map(
              (p) => React.createElement(PromptCard, {
                key: p.id,
                prompt: p,
        ...
        // Import/Export modal
        showImportExport && React.createElement(
          Modal,
          {
